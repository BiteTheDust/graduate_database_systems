...
CREATE TABLE runs(
	...
	FOREIGN KEY (PSSN) REFERENCES Professor(PSSN) ON DELETE CASCADE ON UPDATE CASCADE
	);
...
CREATE TABLE Manage_Proj(
	...
	FOREIGN KEY (PSSN) REFERENCES Professor(PSSN)ON DELETE CASCADE
	);
	
CREATE TABLE work_Proj_professors(
	PID INTEGER,
	PSSN CHAR(10),
...
CREATE TABLE work_Proj_students(
	PID INTEGER,
	SSSN CHAR(10),
	PRIMARY KEY(PID,SSSN),
	FOREIGN KEY (PID) REFERENCES Project(PID) ON DELETE CASCADE,
